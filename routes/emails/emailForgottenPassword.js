const {
  ...
  function template(first, last, email) {
    return `
            ...
            <body style="background-color: #101010; margin: 0 !important; padding: 0 !important;">
                <!-- HIDDEN PREHEADER TEXT -->
                <div style="font-size: 1px; color: #ffffff; line-height: 1px; font-family: 'Lato', Helvetica, Arial, sans-serif; max-height: 0px; max-width: 0px; opacity: 0; overflow: hidden;"> We're thrilled to have you here! Get ready to dive into your new account. </div>
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    <!-- LOGO -->
                    <tr>
                        <td bgcolor="#74009D" align="center">
                    ...
                    <tr>
                        <td bgcolor="#74009D" align="center" style="padding: 0px 10px 0px 10px;">
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                                <tr>
                    ...
                    <tr>
                        <td bgcolor="#101010" align="center" style="padding: 0px 10px 0px 10px;">
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                            <tr>
                            <td bgcolor="#000000" align="left" style="padding: 20px 30px 40px 30px; color: #CCCCCC; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 25px;">
                                <p style="margin: 0;">You can recover your password by clicking <a href="${"https://wallaby-neon.vercel.app"}/${email}/newpassword">here</a>.</p>
                            </td>  
                        </tr>
                        <tr>
                            <td bgcolor="#000000" align="left" style="padding: 0px 30px 20px 30px; color: #CCCCCC; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 25px;">
            ...
            <tr>
                <td bgcolor="#101010" align="center" style="padding: 30px 10px 0px 10px;">
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                        <tr>
